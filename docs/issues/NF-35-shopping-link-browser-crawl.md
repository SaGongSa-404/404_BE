제목: `[feat] NF-35 상품 링크 수집을 브라우저 렌더링 기반 방식으로 개선`

## 관련 키 / 참고 링크
- 트래킹 키: `NF-35`
- 관련 PR / 문서:
  - Jira: https://parkjaehong.atlassian.net/browse/NF-35
  - GitHub Issue: #51
  - 기여: `PHJ2000`
...
- 전체 후보 70개 중 실제 상품 상세 URL을 확보한 샘플은 58개였습니다.
...
- 실제 상품 상세 URL만:
  - 전체 후보: 70개
  - 상품 상세 URL 확보: 58/70
  - 확보된 상품 상세 URL 수집 성공: 58/58 (100.0%)
  - 분류 정확도: 47/58 (81.0%)
- 실험 방식:
