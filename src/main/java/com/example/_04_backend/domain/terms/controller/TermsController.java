package com.example._04_backend.domain.terms.controller;

import com.example._04_backend.domain.terms.dto.TermsDetailResponse;
import com.example._04_backend.domain.terms.dto.TermsSummaryResponse;
...
public class TermsController {
    ...
    private static final Map<TermsType, TermsDetailResponse> TERMS_DETAIL = Map.of(
            TermsType.SERVICE, new TermsDetailResponse(
                    TermsType.SERVICE,
                    "서비스 이용약관",
                    true,
                    """
            ...
            TermsType.PRIVACY, new TermsDetailResponse(
                    TermsType.PRIVACY,
                    "개인정보처리방침",
                    true,
                    """
            ...
            TermsType.MARKETING, new TermsDetailResponse(
                    TermsType.MARKETING,
                    "마케팅 수신 동의",
                    false,
                    """
    ...
    @GetMapping
    public ResponseEntity<List<TermsSummaryResponse>> getTermsList() {
        return ResponseEntity.ok(TERMS_LIST);
    }

    @GetMapping("/{type}")
    public ResponseEntity<TermsDetailResponse> getTermsDetail(@PathVariable TermsType type) {
